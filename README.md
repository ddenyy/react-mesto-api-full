...
[Frontend](https://mesto.frontend.nomoredomains.work)

[Backend](https://api.mesto-frontend.nomoredomains.work/)
...
Сделать возможность посмотреть аватары тех кто поставил like публикации.
реализовать бургерное меню на мобильной версии сайта.
